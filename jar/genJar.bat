...
move "%~dp0\spider.jar\dist\dex.jar" "%~dp0\catvod_spider.jar"

certUtil -hashfile "%~dp0\catvod_spider.jar" MD5 | find /i /v "md5" | find /i /v "certutil" > "%~dp0\catvod_spider.jar.md5"
